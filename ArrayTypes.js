...
let myFish1 = ["parrot", "anemone", "blue", "trumpet", "sturgeon"];
let Removed = myFish1.splice(2, 2);
...
let index1 = sentence.charAt();
console.log(sentence);
console.log("Character at index 0 is  " + index1);
//OUTPUT:-
...
var index_1 = str.indexOf("language");
console.log(index_1); // 57

var index_2 = str.indexOf("p");
console.log(index_2); // 8

// second argument specifies the search's start index
var index_3 = str.indexOf("p", 9);
console.log(index_3); // 45

// indexOf returns -1 if not found
var index_4 = str.indexOf("Python");
console.log(index_4); // -1
...
var index$1 = priceList.lastIndexOf(31);
console.log(index$1); // 3

var index$2 = priceList.lastIndexOf(10);
console.log(index$2); // 4

// second argument specifies the backward search's start index
var index$3 = priceList.lastIndexOf(10, 3);
console.log(index$3); // 0

// lastIndexOf returns -1 if not found
var index$4 = priceList.lastIndexOf(69.5);
